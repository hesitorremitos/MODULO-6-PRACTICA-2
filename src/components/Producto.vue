    ...
    <div class="container" v-for="item in items" :key="item.id">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6  col-md-8">
                ...
                <h5>Colores</h5>
                <div>
                    <div class="color-box clic" v-for="colorx in item.colores" :style="'background:' + colorx"
                        v-on:click="pedido.color = colorx">{{ pedido.color }}</div>
                ...
                <div class="buy-box">
                    ...
                    <button type="button" class="btn btn-primary" v-if="pedido.cantidad > 0 && pedido.color !== null"
                        enabled v-on:click.once="enviar()">Comprar</button>
